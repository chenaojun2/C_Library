...
public class ChViewPrinterProvider {
    ...
    public ChViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin=ChDisplayUtil.dp2px(100,recyclerView.getResources());
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ChDisplayUtil.dp2px(160, rootView.getResources()));
